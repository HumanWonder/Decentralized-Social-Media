(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('mersenne-twister')) :
    typeof define === 'function' && define.amd ? define(['exports', 'mersenne-twister'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["wallet-avatar"] = {}, global.MersenneTwister));
})(this, (function (exports, MersenneTwister) { 'use strict';
    ...
    function HSLToHex(hsl) {
        ...
        s /= 100;
        l /= 100;
        let c = (1 - Math.abs(2 * l - 1)) * s, x = c * (1 - Math.abs(((h / 60) % 2) - 1)), m = l - c / 2, _r = 0, _g = 0, _b = 0;
        if (0 <= h && h < 60) {
            _r = c;
            _g = x;
            _b = 0;
        ...
        let r = Math.round((_r + m) * 255).toString(16), g = Math.round((_g + m) * 255).toString(16), b = Math.round((_b + m) * 255).toString(16);
